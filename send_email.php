...
<div class="container"> <h1 style="color:#4A26AE; text-align:center;">Thank you! We will reply as soon as possible! </h1> </div> 
<?php 
...
$fullmsg = wordwrap($fullmsg,70); 

// send email 


if (mail("hacmaproject@gmx.com", $email,$fullmsg,"From hacmaproject@gmx.com\r\n")) 
{ print "I sent"; 
